...
<h1> Fill Your Details Here</h1>
      ...
      <div class="design">Design : <input type="text" id="d" name="design" value="one"></div>
     ...
     <div class="btn"> <input type="submit" name="submit" formaction="one.php" id="btn" value="SHOW ON CARD"></div>
    </form>
</div>
    <div class="container">
