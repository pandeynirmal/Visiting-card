...
<h1> Fill Your Details Here</h1>
      ...
      <div class="design">Design : <input type="text" id="d" name="design" value="two"></div>
     ...
     <div class="btn"> <input type="submit" name="submit" formaction="two.php" id="btn" value="SHOW ON CARD"></div>
    </form>
</div>
    <div class="container">
    <div class="one" id="one">
            <img src="two.jpg" alt="two template">
